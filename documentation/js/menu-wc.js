...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">it-step-project documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-dd2afe02160b31f405c4e31f2842e17e"' : 'data-target="#xs-components-links-module-AppModule-dd2afe02160b31f405c4e31f2842e17e"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-dd2afe02160b31f405c4e31f2842e17e"' :
                                            'id="xs-components-links-module-AppModule-dd2afe02160b31f405c4e31f2842e17e"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DetailInfoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DetailInfoComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/CustomersService.html" data-type="entity-link">CustomersService</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CustomerRoom.html" data-type="entity-link">CustomerRoom</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
